...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Jasa Sewa Online Bermutu dan Lengkap - Jawatulen</title>
			...
			<div class="navbar-container ace-save-state" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="<?php echo base_url(); ?>" class="navbar-brand">
						<small>
							<i><img src="<?php echo base_url(); ?>assets/images/jawatulen.png"></i>
							<!-- <i class="fa fa-key"></i> -->
							 Jawatulen
						</small>
					</a>
						...
						<li class="light-blue dropdown-modal user-min">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								...
								<span class="user-info">
									<small>Welcome, Imam Saputra</small>
									<!--
									<?php
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-brown dropdown-caret dropdown-close">
								<li>
									<a href="#">
	  		...
	  		&nbsp;
						...
						<form class="navbar-form navbar-right form-search" role="search">
							<div class="form-group">
								<input type="text" placeholder="Ameh nggolek opo le...." />
							</div>

							<button type="button" class="btn btn-mini btn-danger2">
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="brown bolder">Jawatulen</span>
